...
class DistilBertSentimentClassifier(BaseTransformerModel):
    def __init__(self, model_name: str = "distilbert-base-uncased", num_labels: int = 3, dropout_prob: float = 0.1, class_weights=None):
        super(DistilBertSentimentClassifier, self).__init__(model_name, num_labels, dropout_prob, class_weights)
